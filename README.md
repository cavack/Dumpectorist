...
Sprint 3 adds the first structure model layer. See `docs/STRUCTURE.md` for states, input conversion, and tests.

## Next Sprint

Sprint 4 should connect snapshots to the setup-classifier skeleton.
